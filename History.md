## Forgejo as the Primary Coordination Source for CommunityCoins

Originally created in 2021, a GitLab repository hub for CommunityCoins
(https://gitlab.com/c4319) was as a practical solution of two earlier efforts to consolidate proceedings:

- an intermediary based on Sandstorm (https://sandstorm.org), and
- a previous GitLab setup (https://gitlab.com/Communitycoins1).
